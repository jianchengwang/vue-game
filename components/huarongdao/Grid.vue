<template>
  <rect class="grid" :class="{ success }" :id="draging && 'draging'" :x="x" :y="y" :width="width" :height="height" :data-type="this.type" :stroke-width="this.unitSize / 25" @touchstart="handleTouchStart" @touchmove="handleTouchMove" @touchend="handleTouchEnd" @mousedown="handleMouseDown" @mouseup="handleMouseUp" />
</template>
